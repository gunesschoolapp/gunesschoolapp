/**
 * Firestore seed script — run via: node seed-firestore.mjs
 * Populates Firestore with demo data for Gunes English School CRM
 */
...
async function seed(entityName, items) {
  for (const item of items) {
    const id = item._id;
    delete item._id;
    await setDoc(doc(db, entityName, id), { ...item, created_date: new Date().toISOString(), updated_date: new Date().toISOString() });
  }
  console.log(`  ✅ ${entityName}: ${items.length} records`);
}
...
await seed('Course', [
  { _id: 'c1', name: 'General English A1-A2', teacher: 'Sarah Johnson', schedule: 'Mon-Wed-Fri 09:00-10:30', start_date: '2026-01-06', end_date: '2026-06-30', max_students: 12, enrolled_students: ['s1','s2','s3','s4'], status: 'active', room: 'Room 1' },
  { _id: 'c2', name: 'IELTS Preparation', teacher: 'Michael Brown', schedule: 'Tue-Thu 14:00-16:00', start_date: '2026-02-01', end_date: '2026-07-31', max_students: 8, enrolled_students: ['s5','s6'], status: 'active', room: 'Room 2' },
  { _id: 'c3', name: 'Kids English (6-9)', teacher: 'Emma Wilson', schedule: 'Sat 10:00-12:00', start_date: '2026-01-11', end_date: '2026-12-20', max_students: 10, enrolled_students: ['s7','s8','s9'], status: 'active', room: 'Room 3' },
  { _id: 'c4', name: 'Business English B2', teacher: 'Sarah Johnson', schedule: 'Tue-Thu 18:00-19:30', start_date: '2026-03-01', end_date: '2026-08-31', max_students: 8, enrolled_students: ['s10'], status: 'active', room: 'Room 1' },
  { _id: 'c5', name: 'Turkish for Foreigners A1', teacher: 'Ayşe Kara', schedule: 'Mon-Wed 11:00-12:30', start_date: '2026-04-01', end_date: '2026-09-30', max_students: 10, enrolled_students: [], status: 'upcoming', room: 'Room 4' },
]);
...
await seed('Student', [
  ...
  { _id: 's7', full_name: 'Arda Koç', email: 'arda.parent@email.com', phone: '+905551001007', status: 'enrolled', enrollment_status: 'started', enrollment_date: '2026-01-11', cefr_level: 'A1', course_hours: 40, course_price: 800, source: 'referral', course_id: 'c3', nationality: 'Turkish' },
  { _id: 's8', full_name: 'Defne Çelik', email: 'defne.parent@email.com', phone: '+905551001008', status: 'enrolled', enrollment_status: 'started', enrollment_date: '2026-01-11', cefr_level: 'A1', course_hours: 40, course_price: 800, source: 'whatsapp', course_id: 'c3', nationality: 'Turkish' },
  { _id: 's9', full_name: 'Yusuf Kaya', email: 'yusuf.parent@email.com', phone: '+905551001009', status: 'enrolled', enrollment_status: 'started', enrollment_date: '2026-02-01', cefr_level: 'A1', course_hours: 40, course_price: 850, source: 'walk_in', course_id: 'c3', nationality: 'Turkish' },
...
await seed('Invoice', [
  { _id: 'inv1', invoice_number: 'INV-2026-001', invoice_type: 'student', student_id: 's1', amount: 1200, issue_date: '2026-01-05', due_date: '2026-02-05', status: 'paid', payment_status: 'paid', amount_paid: 1200 },
  ...
  { _id: 'inv3', invoice_number: 'INV-2026-003', invoice_type: 'student', student_id: 's5', amount: 2500, issue_date: '2026-02-01', due_date: '2026-03-01', status: 'sent', payment_status: 'partially_paid', amount_paid: 1000 },
...
await seed('Notification', [
  { _id: 'n1', title: 'Payment Overdue', message: 'Elif Şahin has an overdue payment of £2,500', type: 'payment', status: 'pending', recipient: 'admin@gunesenglish.com' },
  { _id: 'n2', title: 'New Lead', message: 'New website inquiry from Hakan Yılmaz', type: 'lead', status: 'pending', recipient: 'admin@gunesenglish.com' },
  { _id: 'n3', title: 'Trial Lesson Scheduled', message: 'Deniz Korkmaz trial lesson on May 22', type: 'lesson', status: 'read', recipient: 'admin@gunesenglish.com' },
]);

await seed('Lead', [
  { _id: 'lead1', full_name: 'Hakan Yılmaz', email: 'hakan@email.com', phone: '+905551112233', source: 'website', status: 'new', interest: 'General English', notes: 'Wants evening classes' },
  { _id: 'lead2', full_name: 'Maria Garcia', email: 'maria@email.com', phone: '+447700112233', source: 'social_media', status: 'contacted', interest: 'Turkish for Foreigners', notes: 'Moving to London' },
  { _id: 'lead3', full_name: 'Deniz Korkmaz', email: 'deniz@email.com', phone: '+905552223344', source: 'referral', status: 'qualified', interest: 'IELTS', notes: 'Needs band 7 for university' },
]);
...
await seed('FormSubmission', [
  { _id: 'fs1', name: 'Hakan Yılmaz', email: 'hakan@email.com', phone: '+905551112233', message: 'I want to learn English', form_type: 'contact', status: 'new' },
]);
